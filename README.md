...
3. Make sure your requirements files are checked in.
   ...
   * For Node.js content, no Python requirements file is needed; dependencies come from your `package.json` and `package-lock.json`.
